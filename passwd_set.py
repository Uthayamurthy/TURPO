...
class Password_Set_Window(ttk.Toplevel):
    def __init__(self, main, PATH, pm):
        ...
        self.info_lbl = ttk.Label(self, text='Welcome to TURPO !', font=('Helvetica', 16, 'bold'))
        self.info_lbl.pack(side='top', padx=10, pady=10)

        self.icon_lbl = ttk.Label(self, image='key')
        self.icon_lbl.pack(side='top', padx=10, pady=10)
        
        self.info_lbl = ttk.Label(self, text='Looks like you haven\'t set a Prime Key yet. So, just setup one ...', font=('Helvetica', 11, 'bold'))
        self.info_lbl.pack(side='top', padx=20, pady=20)
